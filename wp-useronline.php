...
function useronline_page_general_stats($content) {
	...
	if($stats_display['useronline'] == 1) {
		...
		$content .= '<ul>'."\n";
		$content .= '<li>'.sprintf(__ngettext('<strong>%s</strong> user online now.', '<strong>%s</strong> users online now.', number_format_i18n(get_useronline_count()), 'wp-useronline'), number_format_i18n(get_useronline_count())).'</li>'."\n";
		$content .= '<li>'.sprintf(__ngettext('Most users ever online was <strong>%s</strong>.', 'Most users ever online was <strong>%s</strong>.', number_format_i18n(get_most_useronline()), 'wp-useronline'), number_format_i18n(get_most_useronline())).'</li>'."\n";
