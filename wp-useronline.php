 ...
 */
define( 'WP_USERONLINE_VERSION', '4.0.2' );
...
require_once __DIR__ . '/includes/class-wp-useronline-blocks.php';
...
require_once __DIR__ . '/includes/class-wp-useronline-admin.php';
