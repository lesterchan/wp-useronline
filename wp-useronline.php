...
function useronline_header() {
	wp_register_script('wp-useronline', '/wp-content/plugins/wp-useronline/useronline-js-packed.js', false, '2.30');
	echo "\n".'<!-- Start Of Script Generated By WP-UserOnline 2.30 -->'."\n";
	echo '<script type="text/javascript">'."\n";
	echo '/* <![CDATA[ */'."\n";
	echo "\t".'var useronline_ajax_url = \''.get_option('siteurl').'/wp-content/plugins/wp-useronline/wp-useronline.php'."';\n";
